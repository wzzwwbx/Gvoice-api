...
//	int			upload_on				=	1; //是否上传用户词表
	const char* login_params			=	"appid = 579853cd, work_dir = ."; // 登录参数，appid与msc库绑定,请勿随意改动
...
//		printf("上传用户词表成功\n");
//	}
	run_iat("wav/upload.wav", session_begin_params); //iflytek02音频内容为“中美数控”；如果上传了用户词表，识别结果为：“中美速控”。
exit:
//	printf("按任意键退出 ...\n");
//	getchar();
	MSPLogout(); //退出登录
